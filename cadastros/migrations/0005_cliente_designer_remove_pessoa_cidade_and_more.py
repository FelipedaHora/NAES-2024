...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cadastros', '0004_cidade_ativo_pessoa_cadastrado_por'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pendente', 'Pendente'), ('andamento', 'Andamento'), ('concluido', 'Concluido')], max_length=40)),
